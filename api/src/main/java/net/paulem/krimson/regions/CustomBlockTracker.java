...
import net.paulem.krimson.blocks.custom.CustomBlockTypeChecker;
import net.paulem.krimson.regions.container.ChunkBlockContainer;
import net.paulem.krimson.regions.container.GlobalBlockContainer;
import net.paulem.krimson.regions.container.WorldBlockContainer;
import net.paulem.krimson.utils.ChunkUtils;
...
public class CustomBlockTracker {
    ...
    public CustomBlockTracker() {
        KrimsonPlugin.getScheduler().runTaskTimerAsynchronously(() -> tickBlocks(CustomBlock::tickAsync, true), 1, 1);

        KrimsonPlugin.getScheduler().runTaskTimer(() -> tickBlocks(CustomBlock::tickSync, false), 1, 1);
    }
    ...
    public void handleChunkLoad(Chunk chunk) {
        for (Block block : PersistentDataUtils.getBlocksWithCustomData(KrimsonPlugin.getInstance(), chunk, KrimsonAPI::isCustomBlock)) {
